...
Esse script classifica imagens de arroz alinhadas, de formato .png
...
def load_images_and_labels(directories, exclude_dir=None):
    ...
    Importa todos os arquivos do tipo .png
...
def test_model(model, test_images, test_labels):
    ...
    print(f"Acurácia para dados de teste foi: {accuracy * 100:.2f}%")
    return accuracy
